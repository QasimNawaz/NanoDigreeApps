...
public class ListAdapter extends ArrayAdapter<Report> {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        TextView txtGrade = (TextView) view.findViewById(R.id.txt_name);
        TextView txtPosition = (TextView) view.findViewById(R.id.txt_name);
        TextView txtClassAttend = (TextView) view.findViewById(R.id.txt_name);
