...
import com.example.android.miwok.AdapterAndModules.PAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FragmentPagerAdapter pagerAdapter = new PAdapter(getSupportFragmentManager());
        vp.setAdapter(pagerAdapter);

        TabLayout slider = (TabLayout) findViewById(R.id.tab_layout);
